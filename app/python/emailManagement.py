...
<div align="center" class="alignment" style="line-height:10px"><img src="{{ url_for('static', filename='images/washerofpasswords') }}" style="display: block; height: auto; border: 0; width: 214px; max-width: 100%;" width="214"/></div>
</td>
</tr>
</table>
...
<p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 19.2px;"><span style="font-size:30px;color:#2b303a;"><strong style="color:#2b303a;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:30px;">Email </strong><span style="color:#2b303a;"><span style="font-size:30px;"><strong>Verification</strong></span></span><strong style="color:#2b303a;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:30px;"> Code</strong></span></p>
</div>
</div>
</td>
</tr>
...
<p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 22.5px;"><span style="color:#808389;font-size:15px;">Please copy the code over to the verification page to finish the registration for your Laundry Tracker Lite Account!<br/>For all of your Laundry Tracking needs!</span></p>
</div>
</div>
</td>
</tr>
...
<tr>
<td class="pad">
<div style="color:#000000;font-size:32px;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-weight:400;line-height:120%;text-align:center;direction:ltr;letter-spacing:0px;mso-line-height-alt:38.4px;">
<p style="margin: 0;">C O D E </p>
</div>
</td>
</tr>
</table>
...
<tr>
<td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
<div align="center" class="alignment" style="line-height:10px"><img src={{ url_for('static', filename='images/theboi.png') }}" style="display: block; height: auto; border: 0; width: 160px; max-width: 100%;" width="160"/></div>
</td>
</tr>
</table>
...
<tr>
<td class="pad">
<div style="color:#747373;font-size:12px;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-weight:700;line-height:150%;text-align:center;direction:ltr;letter-spacing:0px;mso-line-height-alt:18px;">
<p style="margin: 0;">LaundryTrackerLite</p>
</div>
</td>
</tr>
</table>
